...
//![1]
    ...
    categories << "Jan" << "Feb" << "Mar" << "Apr" << "May" << "Jun" ;//<< "duoyu" << "duoyu2";
//![1]
...
//![6]
    ...
    QWidget* pwCentral = new QWidget();
    QWidget* pwidget01 = new QWidget();
    QHBoxLayout *layout = new QHBoxLayout( pwCentral );

    layout->addWidget(chartView);
    layout->addWidget(pwidget01);
    QWidgetResizeHandler *h = new QWidgetResizeHandler(pwCentral);
    h->setMovingEnabled(true);
//![6]

//![7]
    QMainWindow window;
    window.setCentralWidget(pwCentral);
